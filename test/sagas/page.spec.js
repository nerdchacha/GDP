...
describe('Page saga', function () {
  ...
  it('Should set loader to false after API response', function () {
    const pageIterator = requestPage();
    pageIterator.next();
    pageIterator.next();
    pageIterator.next({ json: () => {} });
