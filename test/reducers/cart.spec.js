...
describe('Cart reducer', () => {
  ...
  it('should not add item to cart for other actions', () => {
  ...
  it('should not remove item from cart for other actions', () => {
  ...
  it('should not empty cart for other action', () => {
