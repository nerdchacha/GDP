...
describe('Actions creators: ', () => {
  it('should return correct actions for appropriate action creator', () => {
  ...
  it('should not return incorrect for appropriate action creator', () => {
  ...
  it('should return correct payload with appropriate action creator', () => {
